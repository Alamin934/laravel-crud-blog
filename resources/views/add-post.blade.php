                    ...
                    <form action="{{route('store_post')}}" method="POST">
                        ...
                        <div class="relative mb-4">
                            ...
                            <textarea id="description" name="description"
                                class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-2 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out @error('description') is-invalid @enderror"></textarea>
                            @error('description')
                            <div class="bg-red-200 p-3 rounded-lg text-red-700">{{ $message }}</div>
                            @enderror
                        </div>
